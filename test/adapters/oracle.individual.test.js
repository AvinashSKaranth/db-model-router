...
const db = require("../../src/oracle/db.js");
...
describe("Oracle Individual Operations", function () {
  this.timeout(30000);
  ...
  before(async function () {
    ...
    await db.query(
      `/* ORACLE_NATIVE */ CREATE TABLE ${tableName} (
  ...
  after(async function () {
    try {
      await db.query(`/* ORACLE_NATIVE */ DROP TABLE ${tableName}`);
    } catch (_) {}
    await db.disconnect();
  });
